...
@section('content')
    <div class="page-inner">
        ...
        @if (auth()->user()->level == 'admin')
            <div class="row">
                <div class="col-md-12">
                    <h4 class="page-title">Log Activitas Dana Keluar</h4>
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive mt-2">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="form-group col-12">
                                ...
                                <input type="hidden" name="type" id="type" class="form-control" value="keluar">
